// src/lib.rs
/*
 * Core library for FinderResource
 */
...
#[derive(Debug)]
pub struct FinderResourceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FinderResourceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FinderResource processing");
    
    let mut processor = FinderResourceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FinderResourceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FinderResourceProcessor::new(false);
